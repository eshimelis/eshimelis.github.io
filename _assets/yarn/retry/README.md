<!-- badges/ -->
[![Build Status](https://secure.travis-ci.org/tim-kos/node-retry.png?branch=master)](https://travis-ci.org/tim-kos/node-retry "Check this project's build status on TravisCI")
