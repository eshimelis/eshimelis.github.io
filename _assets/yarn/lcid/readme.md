...
> Mapping between [standard locale identifiers](https://en.wikipedia.org/wiki/Locale) and [Windows locale identifiers (LCID)](https://en.wikipedia.org/wiki/Locale#Specifics_for_Microsoft_platforms)
